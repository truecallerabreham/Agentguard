...
| **Step 2.2** | Centralise configuration | Completed | `fb3e781` | Created src/agentguard/config.py with ServerSettings and singleton get_settings() |
| **Step 2.3** | Create the auth module | Completed | `b4a4bb9` | Implemented Principal dataclass and TokenValidator with JWKS key fetching |
